...
Another method tried was using a Multi-layered Perceptron (MLP). While MLPs are not efficient or designed for image processing we wanted to have another method to compare to. It extracts features from images by using multiple layers of convolution to extract features and scale each pixel to include nearby features. 
