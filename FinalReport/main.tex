...
self.cnn = nn.Sequential(
    ...
    nn.MaxPool2d(2))
\end{lstlisting}
The model then feeds each pixel and related features into two fully connected layers, and returns the estimated depth. 
